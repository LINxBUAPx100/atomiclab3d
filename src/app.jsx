...
const App = () => {
  ...
  const enviarCotizacion = (e) => {
    ...
    const telefono = '5212221234567'; // Reemplazar con tu número
  ...
  return (
    <>
      ...
      <section id="contacto">
        <div className="reveal">
          ...
          <div className="contact-actions">
            <a href="https://wa.me/5212221234567?text=Hola+Atomic+Lab+3D!+Tengo+una+idea." className="btn-primary" target="_blank" rel="noopener noreferrer">
      ...
      <a className="wa-float" href="https://wa.me/5212221234567?text=Hola!+Quiero+saber+más." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
